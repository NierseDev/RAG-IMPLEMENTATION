...
class LLMService:
    ...
    def create_verify_prompt(
        ...
        return (
            ...
            "Allow mathematical notation and formulas when the context supports them.\n"
    ...
    def create_answer_prompt(
        ...
        return (
            "Synthesize an answer using the provided source texts and evidence.\n"
            f"{self._session_memory_block(conversation_context)}"
            f"Question: {query}\n"
            f"Source texts and evidence:\n{context}\n"
            "Be direct and factual exclude Source text/s, Evidence/s, Provided material/s, Provided context/s from the answer.\n"
            "Decontruct Abbreviations on initial encounter in relation to the sources.\n"
            "Keep the answer within 2 to 5 sentences or 1 to 2 paragraphs.\n"
            "Include bullet points when needed i.e. lists.\n"
            "If the evidence includes a mathematical formula, preserve it exactly and add formula HTML markdown, and explain it using any linked source context.\n"
            "Use nearby source context to describe what the formula means, what each symbol refers to, or how it is used in the document.\n"
            "Use markdown in a needed fashion meaning **bold** should not be thrown around needlessly.\n"
            "Do not copy wording unless an exact term matters.\n"
            "Don't explain the sources and evidences"
            )
